...
<form action="../../php/result.php"  method="POST" accept-charset="UTF-8" class="contact__form" id="contactForm">
			...
			<div class="contact__field">
				<label for="address">Adress (street name)</label>
            ...
            <div class="contact__field">
                <label for="description">What type of property would you like to estimate?</label>
                <div>
				  <input type="radio" id="maison" name="typebien" value="maison" checked>
				  <label for="Maisons">House</label>
				</div>
				<div>
            ...
            <div class="contact__field">
                <label for="surface">What is the area of your house / apartment?</label>
            ...
            <div class="contact__field">
                <label for="surface-terrain">What is the surface of the land (for house)?</label>
			...
			<div class="contact__field">
				<label for="nbpiece">Number of rooms (1-20): (kitchen, bathroom and toilets are not to be taken into account)</label>
				<input type="number" id="nbpiece" name="nbpiece" min="1" max="20" required>
			</div>


			<div class="contact__field">
				<label for="selectfield-year" class="selectfield-year">Year of construction ?</label>
				<input list="year">
				<datalist id="year">
					...
					<option value="After 2008">
				</datalist>	
			</div>
			
			
			<div class="contact__field">
                <label for="description">Are renovations to be expected?</label>
                <div>
				  <input type="radio" id="oui" name="travaux" value="oui" checked>
				  <label for="Maisons">Yes</label>
				</div>
				<div>
            ...
            <!-- Message -->
            <div class="contact__field">
                <label for="description">Describe your property or specify your request</label>
